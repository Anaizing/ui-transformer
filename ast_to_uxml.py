...
# --- Example Usage ---
# Assuming 'button_full_details.json' was generated by the scraping script.
json_filename = "button_full_details.json"
uxml_output_directory = "GeneratedUXML"
...
if os.path.exists(json_filename):
    ...
    print(f"Error: JSON file '{json_filename}' not found. Please run the scraping script first.")
